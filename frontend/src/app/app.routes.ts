...
export const routes: Routes = [
  ...
  { path: 'dashboard', component: ProducerDashboardComponent, canActivate: [authGuard] },
  ...
  { path: 'scanner', loadComponent: () => import('./components/scanner/scanner.component').then(m => m.ScannerComponent), canActivate: [authGuard] },
  { path: '**', redirectTo: '' }
];
